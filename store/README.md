...
| `accent-kpi-card-sample.pbip` | Power BI Project that produces the required sample report |
...
3. **Insert > More visuals > Import a visual from a file** and pick
   `dist/accentKpiCardA5954A8F7A18431E8E2729CD89ED8F8E.1.3.0.0.pbiviz`. If the visual container is still
